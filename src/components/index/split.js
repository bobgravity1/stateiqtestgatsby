...
<>   
    <div className="split">
        ...
        <div className="split-piece split-right">
            <h1>(Free score + IQ Score Analysis) <br />Complete IQ Profile for just $2.99! <br /> </h1>
          
                <div className="split-right-image">
                    <img src={imgTwo} />
                </div>
                <p>Purchase a full Cognitive Analysis for just $2.99 at the end of the test! Every analysis is unique. </p> 
        </div>
    </div>
</>
    )
